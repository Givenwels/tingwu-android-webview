...
后台播放保活会在锁屏或切后台时启动一个 Android 前台服务，并显示“通义听悟正在后台运行”通知；Android 13+ 或部分国产系统如果未授予通知权限，可能只在后台任务/任务管理中显示。回到 App 前台或真正退出 App 时会停止。它使用 partial wake lock 让 CPU 不要立刻休眠，但不会点亮屏幕。
...
1.0.3 起，锁屏和普通切后台会启动后台播放保活服务。若特定手机仍会停止：

- 确认通知栏、后台任务或任务管理中出现“通义听悟正在后台运行”。
